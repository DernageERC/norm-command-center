    ...
    <main className='shell'>
      ...
      {tab === 'home' && (
        <section className='tabPanel'>
          ...
          <div className='mapHero'><div><span className='eyebrow'>Map</span><h1>See nearby. Connect fast.</h1></div><button className='ghostButton' onClick={() => void refresh()} disabled={!location || busy}>Refresh</button></div>
